...
abstract public class TL1Message {
    ...
    protected com.grb.bufferutils.ByteBuffer _buffer;
    protected ArrayList<StackElement> _stack;

    protected TL1Message(int initialCapacity) {
        _buffer = new com.grb.bufferutils.ByteBuffer(initialCapacity);
    ...
    public com.grb.bufferutils.ByteBuffer getBuffer() {
        return _buffer;
    }
